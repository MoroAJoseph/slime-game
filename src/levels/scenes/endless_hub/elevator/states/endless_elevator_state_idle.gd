...
func enter(_prev_state_path: String, _data: Object) -> void:
	...
	_player_detector.player_entered.connect(_on_player_entered)
	_player_detector.player_exited.connect(_on_player_exited)
	_menu.floor_selected.connect(_on_floor_selected)

func exit() -> void:
	_player_detector.player_entered.disconnect(_on_player_entered)
	_player_detector.player_exited.disconnect(_on_player_exited)
