...
func _ready() -> void:
	...
	CLOSE_BUTTON.pressed.connect(func(): UIEvent.EndlessHubDismantler.new(UIEvent.EndlessHubDismantlerAction.CLOSE))
...
func _on_dismantle() -> void:
	...
	UIEvent.EndlessHubDismantler.new(UIEvent.EndlessHubDismantlerAction.DISMANTLE)
	_can_dismantle = true
